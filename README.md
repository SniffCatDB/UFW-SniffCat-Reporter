...
6. **UDP Traffic Filtering** – UDP traffic is automatically skipped.
7. **Report Cooldown** – Prevents duplicate reports of the same IP within a configurable time window.
