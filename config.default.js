exports.MAIN = {
	...
	CACHE_FILE: '/tmp/UFW-To-NetCatDB.cache',
...
https://github.com/sefinek/UFW-To-NetCatDB`; // Please do not remove this URL; I would be very grateful! Thank you. 💙

// Alternative version:
// exports.REPORT_COMMENT = ({ timestamp, In, Out, srcIp, dstIp, res, tos, prec, ttl, id, proto, spt, dpt, len, urgp, mac, window, syn }, fullLog, serverName) =>
// 	`Blocked by UFW ${serverName ? `on ${serverName} ` : ''}[${dpt}/${proto?.toLowerCase()}]. Generated by: https://github.com/sefinek/UFW-To-NetCatDB`;
