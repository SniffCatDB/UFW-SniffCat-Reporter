exports.MAIN = {
	...
	CACHE_FILE: './tmp/ufw-sniffcat-reporter.cache',
	...
	IP_REPORT_COOLDOWN: 12 * 60 * 60 * 1000, // Minimum time between reports of the same IP. Must be >= 20 minutes. Do not set too low values, as it would waste API quota due to daily rate limits.
...
https://github.com/SniffCatDB/UFW-SniffCat-Reporter`; // Please don't delete this URL, I'd be very grateful. Thank you! 💙

// Alternative version:
// exports.REPORT_COMMENT = ({ date, srcIp, dstIp, proto, spt, dpt, In, Out, mac, len, ttl, id, tos, prec, res, window, urgp, syn }, fullLog) =>
// 	`Blocked by UFW ${serverId}[${dpt}/${proto?.toLowerCase()}]. Generated by: https://github.com/SniffCatDB/UFW-SniffCat-Reporter`;
...
const CATEGORIES = {
	...
	2323: [FLAGS.PORT_SCAN, FLAGS.TELNET],
	5555: [FLAGS.PORT_SCAN, FLAGS.TELNET],
	7547: [FLAGS.PORT_SCAN, FLAGS.TELNET],
	8291: [FLAGS.PORT_SCAN, FLAGS.TELNET],

	25:   [FLAGS.PORT_SCAN, FLAGS.EMAIL],
	465:  [FLAGS.PORT_SCAN, FLAGS.EMAIL],
	587:  [FLAGS.PORT_SCAN, FLAGS.EMAIL],
