exports.MAIN = {
	...
	CACHE_FILE: '/tmp/ufw-netcatdb-reporter.cache',
	...
	// Reporting
	NETCATDB_API_KEY: '', // Secret API key for NetCatDB.
...
// Alternative version:
// exports.REPORT_COMMENT = ({ date, srcIp, dstIp, proto, spt, dpt, In, Out, mac, len, ttl, id, tos, prec, res, window, urgp, syn }, fullLog, serverName) =>
// 	`Blocked by UFW ${serverName ? `on ${serverName} ` : ''}[${dpt}/${proto?.toLowerCase()}]. Generated by: https://github.com/sefinek/UFW-NetCatDB-Reporter`;
